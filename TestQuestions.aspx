<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TestQuestions.aspx.cs" Inherits="OP2_LAB4_U4_05.TestQuestions" %>
...
<body>
    <form id="form1" runat="server">
        <div class="window title">Test questions</div>
        ...
        <div class="window">
            ...
            <asp:Label runat="server" Text="Question answer choices (each in new line):"></asp:Label>
            <asp:TextBox style="width: 100%; display: block" ID="InputQuestionAnswerChoices" runat="server" Rows="5" TextMode="MultiLine"></asp:TextBox>
            <asp:RequiredFieldValidator ID="InputQuestionAnswerChoicesValidator" runat="server" ErrorMessage="Question answer choices are required." ControlToValidate="InputQuestionAnswerChoices" ForeColor="Red"></asp:RequiredFieldValidator>
            <br />
